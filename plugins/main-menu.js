...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    if (teks == '404') {
      ...
      const sections = [
      {
        title: 'ʟɪsᴛ ᴍᴇɴᴜ ᴋʜᴜʀᴜsʜɪ ' + data.namabot,
        rows: [
          { title: '❒➪🤖»»sᴇᴍᴜᴀ ᴘᴇʀɪɴᴛᴀʜ', rowId: `${_p + command} all` },
          { title: '❒➪🎮»»ɢᴀᴍᴇ', rowId: `${_p + command} game` },
          { title: '❒➪🎲»»ʀᴘɢ', rowId: `${_p + command} rpg` },
          { title: '❒➪👾»»xᴘ', rowId: `${_p + command} xp` },
          { title: '❒➪✨»»sᴛɪᴄᴋᴇʀ', rowId: `${_p + command} stiker` },
          { title: '❒➪🎀»»ᴋᴇʀᴀɴɢ ᴀᴊᴀɪʙ', rowId: `${_p + command} kerangajaib` },
          { title: '❒➪📢»»ǫᴏᴜᴛᴇs', rowId: `${_p + command} quotes` },
          { title: '❒➪🔐»»ɢʀᴜʙ', rowId: `${_p + command} grup` },
          { title: '❒➪⛔»»ᴀɴɪᴍᴇ', rowId: `${_p + command} anime` },
          { title: '❒➪🔞»»ɴsғᴡ', rowId: `${_p + command} nsfw` },
          { title: '❒➪☢️»»ᴘʀᴇᴍɪᴜᴍ', rowId: `${_p + command} premium` },
          { title: '❒➪📶»»ɪɴᴛᴇʀɴᴇᴛ', rowId: `${_p + command} internet` },
          { title: '❒➪⚠️»»ᴀɴᴏɴʏᴍᴏᴜs', rowId: `${_p + command} anonymous` },
          { title: '❒➪✏️»»ɴᴜʟɪs & ʟᴏɢᴏ', rowId: `${_p + command} nulis` },
          { title: '❒➪⚙️»»ᴅᴏɴʟᴏᴀᴅᴇʀ', rowId: `${_p + command} downloader` },
          { title: '❒➪⚙️»»ᴛᴏᴏʟs', rowId: `${_p + command} tools` },
          { title: '❒➪🔖»»ғᴜɴ', rowId: `${_p + command} fun`},
          ...
          { title: '❒➪🥟»»ᴛᴀɴᴘᴀ ᴋᴀᴛᴇɢᴏʀɪ', rowId: `${_p + command} tanpakategori` },
          { title: '❒➪🤴»»ᴏᴡɴᴇʀ', rowId: `${_p + command} owner` },
        ]
      }
    ]
    const listMessage = {
